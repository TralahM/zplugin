...
link:https://github.com/TralahM/zplugin#ice-modifiers[ice-modifiers]). The logic
...
zplugin load TralahM/zplugin-crasis
```
...
requires `TralahM/fast-syntax-highlighting` (it builds the `ZLAST_COMMANDS`
array).
...
**See also Wiki on
link:https://github.com/TralahM/zplugin/wiki/Multiple-prompts[multiple prompts].**
